...
\input{presentation_images/100-trials_conf-geq-0_sample-from-val/total_passes.tex}

\vspace{.25cm}

\input{presentation_images/100-trials_conf-geq-0_sample-from-val/total_accuracy_for_all_validation.tex}
